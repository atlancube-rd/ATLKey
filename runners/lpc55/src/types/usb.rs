...
>;
pub type CtapHidClass = usbd_ctaphid::CtapHid<'static, 'static, 'static, UsbBus<EnabledUsbPeripheral>>;
...
impl UsbClasses {
    pub fn new(usbd: Usbd, ctaphid: CtapHidClass) -> Self {//, serial: SerialClass) -> Self {
