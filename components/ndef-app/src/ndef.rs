...
impl<'a> App<'a> {
    ...
    // Externally crafted NDEF URL for "https://atlancube.com/"
    pub const NDEF : [u8; 21] = [
        0x00, 0x12, 0xd1, 0x01, 0x0e, 0x55, 0x04, 0x61, 0x74, 0x6c,
        0x61, 0x6e, 0x63, 0x75, 0x62, 0x65, 0x2e, 0x63, 0x6f, 0x6d, 0x2f
    ];
